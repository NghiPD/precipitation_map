...
plt.title('24h accumulated precipitation '+DATEFCST+ ' initialized from '+DATEIN, size=10)
fig.savefig('24h_accumulated_precipitation_'+DATEFCST+'_initialized_from_'+DATEIN+'.png', dpi=300, bbox_inches='tight')
